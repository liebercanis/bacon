...
MGROOTSODEPLIBS = $(foreach package, $(MGROOTSODEPS), /home/gold/XenonDoping/tmp/Linux-g++/$(package)/lib$(package).$(MGLIBEXT))
#MGROOTSODEPLIBS = $(foreach package, $(MGROOTSODEPS), /home/gold/XenonDoping/tmp/Linux-g++/$(package)/lib$(package).$(SHEXT))
ROOTCFLAGS = -pthread -std=c++11 -m64 -I/usr/local/root/include
ROOTLIBS = -L/usr/local/root/lib -lCore -lImt -lRIO -lNet -lHist -lGraf -lGraf3d -lGpad -lROOTDataFrame -lROOTVecOps -lTree -lTreePlayer -lRint -lPostscript -lMatrix -lPhysics -lMathCore -lThread -lMultiProc -pthread -lm -ldl -rdynamic
