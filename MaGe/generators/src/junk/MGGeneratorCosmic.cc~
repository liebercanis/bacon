...
// $Id:
//      
// CLASS IMPLEMENTATION:  MGGeneratorCosmic.cc
//
//---------------------------------------------------------------------------//
/**
* SPECIAL NOTES:
...
const G4double MGGeneratorCosmic::LambdaE = twopi *1.973269602e-16 * m * GeV;

MGGeneratorCosmic::MGGeneratorCosmic()
{
	fGeneratorName = "Cosmic";
	fG4Messenger = new MGGeneratorCosmicMessenger(this);
	fParticleGun = new G4ParticleGun(1);
}

MGGeneratorCosmic::MGGeneratorCosmic(const MGGeneratorCosmic & other) : MGVGenerator(other)
{;}                                                                                       
...
void MGGeneratorCosmic::DirectionDecider()
{
...
void MGGeneratorCosmic::EnergyDecider()
{
...
void MGGeneratorCosmic::PositionDecider()
{
...
G4bool MGGeneratorCosmic::IsInArgon(G4ThreeVector rpos)
{
  bool isit = true;
  // list of all volumes
...
void MGGeneratorCosmic::ParticleDecider()
{
  if(fParticleType == "opticalphoton"){
...
void MGGeneratorCosmic::GeneratePrimaryVertex(G4Event *event)
{
