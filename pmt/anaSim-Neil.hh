...
class anaSim{
  public:
    ...
    std::vector<Double_t> BaselineWMA(std::vector<Double_t> sig,std::vector<Int_t> peaks,Int_t ientry,Int_t N);
    ...
    Double_t minPeakWidth = 5e-9;
    Double_t maxPeakWidth = 500e-9;
