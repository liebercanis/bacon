...
void tripletFitMuon(){
  ...
  for(int z =irunStart;z<=irunStop;z++){
    ...
    */
    ...
    time.push_back(globalTimeStart-globalStartTime);
    time.push_back(globalTimeStop-globalStartTime);
    ...
    Double_t tMaxCut = 2e-6,tMinCut = 0.6e-6,vMaxEventCut = 6e-3,vMinCut = 2e-3,peakWidthCut = 0;//25e-9;
  ...
  hTripletvTime->SetMinimum(1.3e-6);
  hTripletvTime->Draw();
